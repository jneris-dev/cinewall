        ...
        <>
            {video.length > 0 &&
                <section className="w-full">
                    ...
                    <div className="w-full flex tablet:flex-row flex-col flex-wrap relative gap-y-8 -mx-3">
                        {video ?
                            video.slice(0, 4).map((video, key) =>
                                <div className="tablet:w-1/2 w-full px-3" key={key}>
